...
public class TestEvents extends TestCommand {
  ...
  public void setUp() throws IOException {
    prepareWorkspace();
    command = new Events(context);
    header = new String[]{"TIME", "EVENT"};
  }

  @Test
  public void testSimpleFields() {
    testSimpleFields("events");
  }
  ...
  public void testOutput() {
    String[] expectedHeader = new String[]{"TIME", "EVENT"};
    String firstApp = RegexElements.generateAppName("1599745644179_0001");
    String firstEvent = "START";
    logFolder.addResourceManager(new ExpandableLinesOfLogs()
        .addLineWithAppEvent(firstApp, "RANDOM", "RANDOM", firstEvent));
    ...
    List<String[]> expectedRows = Collections.singletonList(
        new String[]{ExpandableLinesOfLogs.getTIMESTAMP(), firstEvent});
