...
/**
 * ComposedPrintable is an aggregation of multiple {@link Printable}s.
 */
public class ComposedPrintable implements Printable {

  private final List<Printable> printables = new ArrayList<>();

  public void addPrintable(Printable printable) {
    Preconditions.checkNotNull(printable);
