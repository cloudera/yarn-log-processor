...
public class TestApplications extends TestCommand {
  ...
  public void setUp() throws IOException {
    prepareWorkspace();
    command = new Applications(context);
    header = new String[]{"TIME", "APPLICATION ID"};
  }

  @Test
  public void testSimpleFields() {
    testSimpleFields("applications");
  }
  ...
  public void testOutput() {
    ...
    logFolder.addResourceManager(new ExpandableLinesOfLogs()
        .addLineWithAppliation(firstApp));
    ...
    List<String[]> expectedRows = Collections.singletonList(
        new String[]{ExpandableLinesOfLogs.getTIMESTAMP(), firstApp});
